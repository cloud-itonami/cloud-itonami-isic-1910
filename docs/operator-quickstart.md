# Operator Quickstart — Coke Oven Products Manufacturing Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 1910** (`cloud-itonami-isic-1910`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1910.git
cd cloud-itonami-isic-1910
```
...
- Blueprint governor key: `coke-operations-governor`
- Likely source path: `coke.governor.cljc`
